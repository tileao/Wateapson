...
function registerCase() {
  ...
  statusText.textContent = `Figure 4-8 / S50-32. PA ${fmt(currentCase.pa,' ft')}, OAT ${fmt(currentCase.oat,'°C')}, WT ${fmt(currentCase.wt,' kg')}, HW ${fmt(currentCase.hw,' kt')}.`;
...
async function buildPdfBlob() {
  ...
  c.fillText('WAC 6800 — Sandbox EAPS OFF', margin, y); y += 30;
  c.font = '18px sans-serif';
  c.fillText(`Figure 4-8 — Weight Limitations for CAT A Offshore Helideck Procedure, EAPS OFF`, margin, y); y += 28;
